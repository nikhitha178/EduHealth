...
const AddTutor = () => {
    ...
    const [speciality, setSpeciality] = useState('Maths')
        ...
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                <div className='flex items-center gap-4 mb-8 text-gray-500'>
                    ...
                    <input onChange={(e) => setTutImg(e.target.files[0])} type="file" name="" id="tut-img" hidden />
                    <p>Upload tutor <br /> picture</p>
                </div>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Fees</p>
                            <input onChange={e => setFees(e.target.value)} value={fees} className='border rounded px-3 py-2' type="number" placeholder='Tutor fees' required />
                        </div>
                ...
                <div>
                    ...
                    <textarea onChange={e => setAbout(e.target.value)} value={about} className='w-full px-4 pt-2 border rounded' rows={5} placeholder='write about tutor'></textarea>
                </div>

                <button type='submit' className='bg-primary px-10 py-3 mt-4 text-white rounded-full'>Add tutor</button>
